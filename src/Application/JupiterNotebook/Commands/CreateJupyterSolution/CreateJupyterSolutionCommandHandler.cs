...
public class CreateJupyterSolutionCommandHandler : IRequestHandler<CreateJupyterSolutionCommand, CreateJupyterSolutionResponseDto>
{
	private readonly IApplicationDbContext context;
	private readonly IFileStorage fileStorage;
	private readonly ILogger<CreateJupyterSolutionCommandHandler> logger;

	public CreateJupyterSolutionCommandHandler(IApplicationDbContext context, IFileStorage fileStorage, ILogger<CreateJupyterSolutionCommandHandler> logger)
	{
	...
	public async Task<CreateJupyterSolutionResponseDto> Handle(CreateJupyterSolutionCommand request, CancellationToken cancellationToken)
	{
		var result = new CreateJupyterSolutionResponseDto();
	...
	{
		var filePath = await this.fileStorage.SaveFileAsync(f.Base64, solutionId, f.FileName);
