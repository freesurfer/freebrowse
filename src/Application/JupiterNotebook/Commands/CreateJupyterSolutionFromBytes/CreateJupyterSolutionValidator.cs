...
public class CreateJupyterSolutionFromBytesValidator : AbstractValidator<CreateJupyterSolutionFromBytesCommand>
{
	public CreateJupyterSolutionFromBytesValidator()
	{
